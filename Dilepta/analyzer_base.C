...
void analyzer_base::Init(TChain *tree, Bool_t isitMC, Bool_t domakelog)
{
   ...
   fChain->SetBranchAddress("NoCutAODCaloJetPt", &NoCutAODCaloJetPt, &b_NoCutAODCaloJetPt);
   fChain->SetBranchAddress("NoCutAODCaloJetEta", &NoCutAODCaloJetEta, &b_NoCutAODCaloJetEta);
   fChain->SetBranchAddress("NoCutemEF", &NoCutemEF, &b_NoCutemEF);
   fChain->SetBranchAddress("NoCuteFH", &NoCuteFH, &b_NoCuteFH);
   fChain->SetBranchAddress("PtCutAODCaloJetPt", &PtCutAODCaloJetPt, &b_PtCutAODCaloJetPt);
   fChain->SetBranchAddress("PtCutAODCaloJetEta", &PtCutAODCaloJetEta, &b_PtCutAODCaloJetEta);
   fChain->SetBranchAddress("PtCutemEF", &PtCutemEF, &b_PtCutemEF);
   fChain->SetBranchAddress("PtCuteFH", &PtCuteFH, &b_PtCuteFH);
   fChain->SetBranchAddress("EtaCutAODCaloJetPt", &EtaCutAODCaloJetPt, &b_EtaCutAODCaloJetPt);
   fChain->SetBranchAddress("EtaCutAODCaloJetEta", &EtaCutAODCaloJetEta, &b_EtaCutAODCaloJetEta);
   fChain->SetBranchAddress("EtaCutemEF", &EtaCutemEF, &b_EtaCutemEF);
   fChain->SetBranchAddress("EtaCuteFH", &EtaCuteFH, &b_EtaCuteFH);
   fChain->SetBranchAddress("FracCutAODCaloJetPt", &FracCutAODCaloJetPt, &b_FracCutAODCaloJetPt);
   fChain->SetBranchAddress("FracCutAODCaloJetEta", &FracCutAODCaloJetEta, &b_FracCutAODCaloJetEta);
   fChain->SetBranchAddress("FracCutemEF", &FracCutemEF, &b_FracCutemEF);
   fChain->SetBranchAddress("FracCuteFH", &FracCuteFH, &b_FracCuteFH);
   fChain->SetBranchAddress("AllCutemEF", &AllCutemEF, &b_AllCutemEF);
   fChain->SetBranchAddress("AllCuteFH", &AllCuteFH, &b_AllCuteFH);
