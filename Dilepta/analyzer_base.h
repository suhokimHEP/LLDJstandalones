...
public :
   ...
   std::vector<float>   *NoCutAODCaloJetPt;
   std::vector<float>   *NoCutAODCaloJetEta;
   std::vector<float>   *NoCutemEF;
   std::vector<float>   *NoCuteFH;
   std::vector<float>   *PtCutAODCaloJetPt;
   std::vector<float>   *PtCutAODCaloJetEta;
   std::vector<float>   *PtCutemEF;
   std::vector<float>   *PtCuteFH;
   std::vector<float>   *EtaCutAODCaloJetPt;
   std::vector<float>   *EtaCutAODCaloJetEta;
   std::vector<float>   *EtaCutemEF;
   std::vector<float>   *EtaCuteFH;
   std::vector<float>   *FracCutAODCaloJetPt;
   std::vector<float>   *FracCutAODCaloJetEta;
   std::vector<float>   *FracCutemEF;
   std::vector<float>   *FracCuteFH;
   std::vector<float>   *AllCutemEF;
   std::vector<float>   *AllCuteFH;
   ...
   TBranch        *b_NoCutAODCaloJetPt;   //!
   TBranch        *b_NoCutAODCaloJetEta;   //!
   TBranch        *b_NoCutemEF;   //!
   TBranch        *b_NoCuteFH;   //!
   TBranch        *b_PtCutAODCaloJetPt;   //!
   TBranch        *b_PtCutAODCaloJetEta;   //!
   TBranch        *b_PtCutemEF;   //!
   TBranch        *b_PtCuteFH;   //!
   TBranch        *b_EtaCutAODCaloJetPt;   //!
   TBranch        *b_EtaCutAODCaloJetEta;   //!
   TBranch        *b_EtaCutemEF;   //!
   TBranch        *b_EtaCuteFH;   //!
   TBranch        *b_FracCutAODCaloJetPt;   //!
   TBranch        *b_FracCutAODCaloJetEta;   //!
   TBranch        *b_FracCutemEF;   //!
   TBranch        *b_FracCuteFH;   //!
   TBranch        *b_AllCutemEF;   //!
   TBranch        *b_AllCuteFH;   //!
   TBranch        *b_llpId;   //!
   TBranch        *b_llpStatus;   //!
   TBranch        *b_llpPt;   //!
