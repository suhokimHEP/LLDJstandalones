...
public :
 ...
 // DiCutflow histograms
 Bool_t        initDiCutflowHistograms( TString uncbin );
 Bool_t        fillDiCutflowHistograms(Float_t weight, int selbin, Int_t localselint);
 Bool_t        writeDiCutflowHistograms(int selbin);
 Bool_t        deleteDiCutflowHistograms(int selbin);
 ...
 // Basic Variables
 Bool_t        initBasicHistograms( TString uncbin );
 Bool_t        fillBasicHistograms(Float_t weight, int selbin );
 Bool_t        writeBasicHistograms(int selbin);
 Bool_t        deleteBasicHistograms(int selbin);
 ...
 // DileptonPt Variables
 Bool_t        initLowDiPtHistograms( TString uncbin );
 Bool_t        fillLowDiPtHistograms(Float_t weight, int selbin);
 Bool_t        writeLowDiPtHistograms(int selbin);
 Bool_t        deleteLowDiPtHistograms(int selbin);
 // DileptonPt Variables
 Bool_t        initHighDiPtHistograms( TString uncbin );
 Bool_t        fillHighDiPtHistograms(Float_t weight, int selbin);
 Bool_t        writeHighDiPtHistograms(int selbin);
 Bool_t        deleteHighDiPtHistograms(int selbin);
 // DileptonPt Variables
 Bool_t        initDiPtHistograms( TString uncbin );
 Bool_t        fillDiPtHistograms(Float_t weight, int selbin);
 Bool_t        writeDiPtHistograms(int selbin);
 Bool_t        deleteDiPtHistograms(int selbin);
...
//Double Electron
 ...
 // DiCutflow histograms 
 TH1F* h_highCutflow                       [SELBINNAMESIZE];
 TH1F* h_highOnecut                        [SELBINNAMESIZE];
 TH1F* h_highRawCutflow                    [SELBINNAMESIZE];
 TH1F* h_highRawOnecut                     [SELBINNAMESIZE];
 TH1F* h_lowCutflow                       [SELBINNAMESIZE];
 TH1F* h_lowOnecut                        [SELBINNAMESIZE];
 TH1F* h_lowRawCutflow                    [SELBINNAMESIZE];
 TH1F* h_lowRawOnecut                     [SELBINNAMESIZE];
 
 // Basic
 TH1F*  h_NoCutemEF                    [SELBINNAMESIZE]; //;
 TH1F*  h_NoCuteFH             [SELBINNAMESIZE]; //;
 TH1F*  h_NoCutAODCaloJetPt                    [SELBINNAMESIZE]; //;
 TH1F*  h_NoCutAODCaloJetEta                    [SELBINNAMESIZE]; //;
 TH1F*  h_PtCutemEF                    [SELBINNAMESIZE]; //;
 TH1F*  h_PtCuteFH             [SELBINNAMESIZE]; //;
 TH1F*  h_PtCutAODCaloJetPt                    [SELBINNAMESIZE]; //;
 TH1F*  h_PtCutAODCaloJetEta                    [SELBINNAMESIZE]; //;
 TH1F*  h_EtaCutemEF                    [SELBINNAMESIZE]; //;
 TH1F*  h_EtaCuteFH             [SELBINNAMESIZE]; //;
 TH1F*  h_EtaCutAODCaloJetPt                    [SELBINNAMESIZE]; //;
 TH1F*  h_EtaCutAODCaloJetEta                    [SELBINNAMESIZE]; //;
 TH1F*  h_FracCutemEF                    [SELBINNAMESIZE]; //;
 TH1F*  h_FracCuteFH             [SELBINNAMESIZE]; //;
 TH1F*  h_FracCutAODCaloJetPt                    [SELBINNAMESIZE]; //;
 TH1F*  h_FracCutAODCaloJetEta                    [SELBINNAMESIZE]; //;
 TH1F*  h_AllCutemEF                    [SELBINNAMESIZE]; //;
 TH1F*  h_AllCuteFH             [SELBINNAMESIZE]; //;
 ...
 // MET / HT
 TH1F*  h_lowpt_leadpt              [SELBINNAMESIZE];
 TH1F*  h_lowpt_leadEta              [SELBINNAMESIZE];
 TH1F*  h_lowpt_leadE              [SELBINNAMESIZE];
 TH1F*  h_lowpt_lagpt              [SELBINNAMESIZE];
 TH1F*  h_lowpt_lagEta              [SELBINNAMESIZE];
 TH1F*  h_lowpt_lagE              [SELBINNAMESIZE];
 TH1F*  h_lowpt_dileppt              [SELBINNAMESIZE];
 TH1F*  h_lowpt_dilepEta              [SELBINNAMESIZE];
 TH1F*  h_lowpt_Phidiff              [SELBINNAMESIZE];
 TH1F*  h_lowpt_dilepE              [SELBINNAMESIZE];
 TH1F*  h_lowpt_dilepMass              [SELBINNAMESIZE];
 
 // MET / HT
 TH1F*  h_highpt_leadpt              [SELBINNAMESIZE];
 TH1F*  h_highpt_leadEta              [SELBINNAMESIZE];
 TH1F*  h_highpt_leadE              [SELBINNAMESIZE];
 TH1F*  h_highpt_lagpt              [SELBINNAMESIZE];
 TH1F*  h_highpt_lagEta              [SELBINNAMESIZE];
 TH1F*  h_highpt_lagE              [SELBINNAMESIZE];
 TH1F*  h_highpt_dileppt              [SELBINNAMESIZE];
 TH1F*  h_highpt_dilepEta              [SELBINNAMESIZE];
 TH1F*  h_highpt_Phidiff              [SELBINNAMESIZE];
 TH1F*  h_highpt_dilepE              [SELBINNAMESIZE];
 TH1F*  h_highpt_dilepMass              [SELBINNAMESIZE];

 // MET / HT
 TH1F*  h_pt_leadpt              [SELBINNAMESIZE];
 TH1F*  h_pt_leadEta              [SELBINNAMESIZE];
 TH1F*  h_pt_leadE              [SELBINNAMESIZE];
 TH1F*  h_pt_lagpt              [SELBINNAMESIZE];
 TH1F*  h_pt_lagEta              [SELBINNAMESIZE];
 TH1F*  h_pt_lagE              [SELBINNAMESIZE];
 TH1F*  h_pt_dilepEta              [SELBINNAMESIZE];
 TH1F*  h_pt_Phidiff              [SELBINNAMESIZE];
 TH1F*  h_pt_dilepE              [SELBINNAMESIZE];
 ...
 TH1F*  h_lownCaloJet                       [SELBINNAMESIZE]; // AODnCaloJet; 
 TH1F*  h_highnCaloJet                       [SELBINNAMESIZE]; // AODnCaloJet; 
