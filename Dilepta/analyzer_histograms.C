...
Bool_t analyzer_histograms::fillSelectedHistograms(Float_t weight, int selbin)
{
 ...
 fillBasicHistograms             ( weight, selbin );
...
// fillDiPtHistograms	         ( weight, selbin );
// fillLowDiPtHistograms	         ( weight, selbin );
// fillHighDiPtHistograms          ( weight, selbin );
...
// writeDiPtHistograms		  ( selbin );
// writeLowDiPtHistograms		  ( selbin );
// writeHighDiPtHistograms 	  ( selbin );
...
//----------------------------initBasicHistograms
Bool_t analyzer_histograms::initBasicHistograms( TString uncbin ){
 for(unsigned int i=0; i<selbinnames.size(); ++i){
   hist_file_out[i]->cd();
   //deleteEleHistograms(i);
   
   TString hname_NoCutemEF                    = "h_"+selbinnames[i]+"_NoCutemEF"        +uncbin; 
   TString hname_NoCuteFH                   = "h_"+selbinnames[i]+"_NoCuteFH"       +uncbin; 
   TString hname_NoCutAODCaloJetPt                  = "h_"+selbinnames[i]+"_NoCutAODCaloJetPt"      +uncbin; 
   TString hname_NoCutAODCaloJetEta                  = "h_"+selbinnames[i]+"_NoCutAODCaloJetEta"      +uncbin; 
   TString hname_PtCutemEF                    = "h_"+selbinnames[i]+"_PtCutemEF"        +uncbin; 
   TString hname_PtCuteFH                   = "h_"+selbinnames[i]+"_PtCuteFH"       +uncbin; 
   TString hname_PtCutAODCaloJetPt                  = "h_"+selbinnames[i]+"_PtCutAODCaloJetPt"      +uncbin; 
   TString hname_PtCutAODCaloJetEta                  = "h_"+selbinnames[i]+"_PtCutAODCaloJetEta"      +uncbin; 
   TString hname_EtaCutemEF                    = "h_"+selbinnames[i]+"_EtaCutemEF"        +uncbin; 
   TString hname_EtaCuteFH                   = "h_"+selbinnames[i]+"_EtaCuteFH"       +uncbin; 
   TString hname_EtaCutAODCaloJetPt                  = "h_"+selbinnames[i]+"_EtaCutAODCaloJetPt"      +uncbin; 
   TString hname_EtaCutAODCaloJetEta                  = "h_"+selbinnames[i]+"_EtaCutAODCaloJetEta"      +uncbin; 
   TString hname_FracCutemEF                    = "h_"+selbinnames[i]+"_FracCutemEF"        +uncbin; 
   TString hname_FracCuteFH                   = "h_"+selbinnames[i]+"_FracCuteFH"       +uncbin; 
   TString hname_FracCutAODCaloJetPt                  = "h_"+selbinnames[i]+"_FracCutAODCaloJetPt"      +uncbin; 
   TString hname_FracCutAODCaloJetEta                  = "h_"+selbinnames[i]+"_FracCutAODCaloJetEta"      +uncbin; 
   TString hname_AllCutemEF                    = "h_"+selbinnames[i]+"_AllCutemEF"        +uncbin; 
   TString hname_AllCuteFH                   = "h_"+selbinnames[i]+"_AllCuteFH"       +uncbin; 
   
   h_NoCutemEF                     [i]= initSingleHistogramTH1F( hname_NoCutemEF                    , "NoCutemEF                   ", 100,  -2, 2) ;  
   h_NoCuteFH                    [i]= initSingleHistogramTH1F( hname_NoCuteFH                   , "NoCuteFH                  ", 100, -2, 2) ;  
   h_NoCutAODCaloJetPt                   [i]= initSingleHistogramTH1F( hname_NoCutAODCaloJetPt                  , "NoCutAODCaloJetPt                 ", 100, 0, 100); 
   h_NoCutAODCaloJetEta                   [i]= initSingleHistogramTH1F( hname_NoCutAODCaloJetEta                  , "NoCutAODCaloJetEta                 ", 100, -5, 5); 
   h_PtCutemEF                     [i]= initSingleHistogramTH1F( hname_PtCutemEF                    , "PtCutemEF                   ", 100,  -2, 2) ;  
   h_PtCuteFH                    [i]= initSingleHistogramTH1F( hname_PtCuteFH                   , "PtCuteFH                  ", 100, -2, 2) ;  
   h_PtCutAODCaloJetPt                   [i]= initSingleHistogramTH1F( hname_PtCutAODCaloJetPt                  , "PtCutAODCaloJetPt                 ", 100, 0, 100); 
   h_PtCutAODCaloJetEta                   [i]= initSingleHistogramTH1F( hname_PtCutAODCaloJetEta                  , "PtCutAODCaloJetEta                 ", 100, -5, 5); 
   h_EtaCutemEF                     [i]= initSingleHistogramTH1F( hname_EtaCutemEF                    , "EtaCutemEF                   ", 100,  -2, 2) ;  
   h_EtaCuteFH                    [i]= initSingleHistogramTH1F( hname_EtaCuteFH                   , "EtaCuteFH                  ", 100, -2, 2) ;  
   h_EtaCutAODCaloJetPt                   [i]= initSingleHistogramTH1F( hname_EtaCutAODCaloJetPt                  , "EtaCutAODCaloJetPt                 ", 100, 0, 100); 
   h_EtaCutAODCaloJetEta                   [i]= initSingleHistogramTH1F( hname_EtaCutAODCaloJetEta                  , "EtaCutAODCaloJetEta                 ", 100, -5, 5); 
   h_FracCutemEF                     [i]= initSingleHistogramTH1F( hname_FracCutemEF                    , "FracCutemEF                   ", 100,  -2, 2) ;  
   h_FracCuteFH                    [i]= initSingleHistogramTH1F( hname_FracCuteFH                   , "FracCuteFH                  ", 100, -2, 2) ;  
   h_FracCutAODCaloJetPt                   [i]= initSingleHistogramTH1F( hname_FracCutAODCaloJetPt                  , "FracCutAODCaloJetPt                 ", 100, 0, 100); 
   h_FracCutAODCaloJetEta                   [i]= initSingleHistogramTH1F( hname_FracCutAODCaloJetEta                  , "FracCutAODCaloJetEta                 ", 100, -5, 5); 
   h_AllCutemEF                     [i]= initSingleHistogramTH1F( hname_AllCutemEF                    , "AllCutemEF                   ", 100,  -2, 2) ;  
   h_AllCuteFH                    [i]= initSingleHistogramTH1F( hname_AllCuteFH                   , "AllCuteFH                  ", 100, -2, 2) ;  
 }
...
//----------------------------fillBasicHistograms
Bool_t analyzer_histograms::fillBasicHistograms(Float_t weight, int selbin )
{
  hist_file_out[selbin]->cd();
  if(NoCutAODCaloJetPt->size() > 0){
  h_NoCutAODCaloJetPt            [selbin] ->Fill( NoCutAODCaloJetPt->at(0), weight );
  h_NoCutAODCaloJetEta           [selbin] ->Fill( NoCutAODCaloJetEta->at(0), weight );

}
  if(NoCutemEF->size()>0){
  h_NoCutemEF            [selbin] ->Fill( NoCutemEF->at(0), weight );

}
  if(NoCuteFH->size()>0){
  h_NoCuteFH            [selbin] ->Fill( NoCuteFH->at(0), weight );

}
  if(PtCutAODCaloJetPt->size() > 0){
  h_PtCutAODCaloJetPt            [selbin] ->Fill( PtCutAODCaloJetPt->at(0), weight );
  h_PtCutAODCaloJetEta           [selbin] ->Fill( PtCutAODCaloJetEta->at(0), weight );

}
  if(PtCutemEF->size()>0){
  h_PtCutemEF            [selbin] ->Fill( PtCutemEF->at(0), weight );

}
  if(PtCuteFH->size()>0){
  h_PtCuteFH            [selbin] ->Fill( PtCuteFH->at(0), weight );

}
  if(EtaCutAODCaloJetPt->size() > 0){
  h_EtaCutAODCaloJetPt            [selbin] ->Fill( EtaCutAODCaloJetPt->at(0), weight );
  h_EtaCutAODCaloJetEta           [selbin] ->Fill( EtaCutAODCaloJetEta->at(0), weight );

}
  if(EtaCutemEF->size()>0){
  h_EtaCutemEF            [selbin] ->Fill( EtaCutemEF->at(0), weight );

}
  if(EtaCuteFH->size()>0){
  h_EtaCuteFH            [selbin] ->Fill( EtaCuteFH->at(0), weight );

}
  if(FracCutAODCaloJetPt->size() > 0){
  h_FracCutAODCaloJetPt            [selbin] ->Fill( FracCutAODCaloJetPt->at(0), weight );
  h_FracCutAODCaloJetEta           [selbin] ->Fill( FracCutAODCaloJetEta->at(0), weight );

}
  if(FracCutemEF->size()>0){
  h_FracCutemEF            [selbin] ->Fill( FracCutemEF->at(0), weight );

}
  if(FracCuteFH->size()>0){
  h_FracCuteFH            [selbin] ->Fill( FracCuteFH->at(0), weight );

}
  if(AllCutemEF->size()>0){
  h_AllCutemEF            [selbin] ->Fill( AllCutemEF->at(0), weight );

}
  if(AllCuteFH->size()>0){
  h_AllCuteFH            [selbin] ->Fill( AllCuteFH->at(0), weight );
...
Bool_t analyzer_histograms::writeBasicHistograms(int selbin)
{
  hist_file_out[selbin]->cd();
  
  h_NoCutemEF            [selbin] ->Write();
  h_NoCuteFH          [selbin] ->Write();
  h_NoCutAODCaloJetPt          [selbin] ->Write();
  h_NoCutAODCaloJetEta          [selbin] ->Write();
  h_PtCutemEF            [selbin] ->Write();
  h_PtCuteFH          [selbin] ->Write();
  h_PtCutAODCaloJetPt          [selbin] ->Write();
  h_PtCutAODCaloJetEta          [selbin] ->Write();
  h_EtaCutemEF            [selbin] ->Write();
  h_EtaCuteFH          [selbin] ->Write();
  h_EtaCutAODCaloJetPt          [selbin] ->Write();
  h_EtaCutAODCaloJetEta          [selbin] ->Write();
  h_FracCutemEF            [selbin] ->Write();
  h_FracCuteFH          [selbin] ->Write();
  h_FracCutAODCaloJetPt          [selbin] ->Write();
  h_FracCutAODCaloJetEta          [selbin] ->Write();
  h_AllCutemEF            [selbin] ->Write();
  h_AllCuteFH          [selbin] ->Write();
  return kTRUE;
}

//----------------------------deleteBasicHistograms
Bool_t analyzer_histograms::deleteBasicHistograms(int selbin)
{
  //printf("deleteEleHistograms\n");
  hist_file_out[selbin]->cd();
  if(h_NoCutemEF[selbin]!=NULL)            h_NoCutemEF            [selbin] ->Delete();
  if(h_NoCuteFH[selbin]!=NULL)           h_NoCuteFH           [selbin] ->Delete();
  if(h_NoCutAODCaloJetPt[selbin]!=NULL)          h_NoCutAODCaloJetPt          [selbin] ->Delete();
  if(h_NoCutAODCaloJetEta[selbin]!=NULL)          h_NoCutAODCaloJetEta          [selbin] ->Delete();
  if(h_PtCutemEF[selbin]!=NULL)            h_PtCutemEF            [selbin] ->Delete();
  if(h_PtCuteFH[selbin]!=NULL)           h_PtCuteFH           [selbin] ->Delete();
  if(h_PtCutAODCaloJetPt[selbin]!=NULL)          h_PtCutAODCaloJetPt          [selbin] ->Delete();
  if(h_PtCutAODCaloJetEta[selbin]!=NULL)          h_PtCutAODCaloJetEta          [selbin] ->Delete();
  if(h_EtaCutemEF[selbin]!=NULL)            h_EtaCutemEF            [selbin] ->Delete();
  if(h_EtaCuteFH[selbin]!=NULL)           h_EtaCuteFH           [selbin] ->Delete();
  if(h_EtaCutAODCaloJetPt[selbin]!=NULL)          h_EtaCutAODCaloJetPt          [selbin] ->Delete();
  if(h_EtaCutAODCaloJetEta[selbin]!=NULL)          h_EtaCutAODCaloJetEta          [selbin] ->Delete();
  if(h_FracCutemEF[selbin]!=NULL)            h_FracCutemEF            [selbin] ->Delete();
  if(h_FracCuteFH[selbin]!=NULL)           h_FracCuteFH           [selbin] ->Delete();
  if(h_FracCutAODCaloJetPt[selbin]!=NULL)          h_FracCutAODCaloJetPt          [selbin] ->Delete();
  if(h_FracCutAODCaloJetEta[selbin]!=NULL)          h_FracCutAODCaloJetEta          [selbin] ->Delete();
  if(h_AllCutemEF[selbin]!=NULL)            h_AllCutemEF            [selbin] ->Delete();
  if(h_AllCuteFH[selbin]!=NULL)           h_AllCuteFH           [selbin] ->Delete();
 return kTRUE;
}
//----------------------------initEleHistograms
...
//----------------------------initptHistograms
Bool_t analyzer_histograms::initDiPtHistograms( TString uncbin ){
  ...
  for(unsigned int i=0; i<selbinnames.size(); ++i){
    ...
    TString hname_pt_leadpt                = "h_"+selbinnames[i]+"_pt_leadpt"  +uncbin ; 
    TString hname_pt_leadEta               = "h_"+selbinnames[i]+"_pt_leadEta"  +uncbin ; 
    TString hname_pt_leadE                 = "h_"+selbinnames[i]+"_pt_leadE"  +uncbin ; 
    TString hname_pt_lagpt                = "h_"+selbinnames[i]+"_pt_lagpt"  +uncbin ; 
    TString hname_pt_lagEta               = "h_"+selbinnames[i]+"_pt_lagEta"  +uncbin ; 
    TString hname_pt_lagE                 = "h_"+selbinnames[i]+"_pt_lagE"  +uncbin ; 
    TString hname_pt_dilepEta               = "h_"+selbinnames[i]+"_pt_dilepEta"  +uncbin ; 
    TString hname_pt_Phidiff               = "h_"+selbinnames[i]+"_pt_dilepdiff"  +uncbin ; 
    TString hname_pt_dilepE               = "h_"+selbinnames[i]+"_pt_dilepE"  +uncbin ; 
    
    h_pt_leadpt    [i] = initSingleHistogramTH1F( hname_pt_leadpt   , "AOD_pt_leadpt  " , 50, 0, 400); 
    h_pt_leadEta    [i] = initSingleHistogramTH1F( hname_pt_leadEta   , "AOD_pt_leadEta  " , 30, -5, 5); 
    h_pt_leadE    [i] = initSingleHistogramTH1F( hname_pt_leadE   , "AOD_pt_leadE  " , 50, 0, 400); 
    h_pt_lagpt    [i] = initSingleHistogramTH1F( hname_pt_lagpt   , "AOD_pt_lagpt  " , 50, 0, 400); 
    h_pt_lagEta    [i] = initSingleHistogramTH1F( hname_pt_lagEta   , "AOD_pt_lagEta  " , 30, -5, 5); 
    h_pt_lagE    [i] = initSingleHistogramTH1F( hname_pt_lagE   , "AOD_pt_lagE  " , 50, 0, 400); 
    h_pt_dilepEta    [i] = initSingleHistogramTH1F( hname_pt_dilepEta   , "AOD_pt_dilepEta  " , 30, -5, 5); 
    h_pt_Phidiff    [i] = initSingleHistogramTH1F( hname_pt_Phidiff   , "AOD_pt_Phidiff  " , 30, -5, 5); 
    h_pt_dilepE    [i] = initSingleHistogramTH1F( hname_pt_dilepE   , "AOD_pt_dilepE  " , 50, 0, 400); 
  }
...
//----------------------------fillDiPtHistograms
Bool_t analyzer_histograms::fillDiPtHistograms(Float_t weight, int selbin)
{
  hist_file_out[selbin]->cd();
 if (fourVec_l1.Pt()>fourVec_l2.Pt()){
 h_pt_leadpt              [selbin]->Fill( fourVec_l1.Pt() , weight);  
 h_pt_leadEta             [selbin]->Fill( fourVec_l1.Eta()  , weight);  
 h_pt_leadE               [selbin]->Fill( fourVec_l1.E()  , weight); 
 h_pt_lagpt               [selbin]->Fill( fourVec_l2.Pt()  , weight); 
 h_pt_lagEta              [selbin]->Fill( fourVec_l2.Eta()  , weight); 
 h_pt_lagE                [selbin]->Fill( fourVec_l2.E()  , weight);}
else{ 
 h_pt_leadpt              [selbin]->Fill( fourVec_l2.Pt() , weight);  
 h_pt_leadEta             [selbin]->Fill( fourVec_l2.Eta()  , weight);  
 h_pt_leadE               [selbin]->Fill( fourVec_l2.E()  , weight); 
 h_pt_lagpt               [selbin]->Fill( fourVec_l1.Pt()  , weight); 
 h_pt_lagEta              [selbin]->Fill( fourVec_l1.Eta()  , weight); 
 h_pt_lagE                [selbin]->Fill( fourVec_l1.E()  , weight);}

 h_pt_dilepEta            [selbin]->Fill( fourVec_ll.Eta()  , weight); 
 h_pt_Phidiff             [selbin]->Fill( fabs(fourVec_l1.Phi()-fourVec_l2.Phi()) , weight); 
 h_pt_dilepE              [selbin]->Fill( fourVec_ll.E()  , weight); 
 return kTRUE;
}

//----------------------------writeDiPtHistograms
Bool_t analyzer_histograms::writeDiPtHistograms(int selbin)
{
  hist_file_out[selbin]->cd();
  h_pt_leadpt             [selbin]->Write(); 
  h_pt_leadEta            [selbin]->Write(); 
  h_pt_leadE              [selbin]->Write(); 
  h_pt_lagpt              [selbin]->Write(); 
  h_pt_lagEta             [selbin]->Write(); 
  h_pt_lagE               [selbin]->Write(); 
  h_pt_dilepEta           [selbin]->Write(); 
  h_pt_Phidiff            [selbin]->Write(); 
  h_pt_dilepE             [selbin]->Write(); 
  return kTRUE;
}

//----------------------------deleteDiPtHistograms
Bool_t analyzer_histograms::deleteDiPtHistograms(int selbin)
{
  //printf("deleteMETHTHistograms\n");
  hist_file_out[selbin]->cd();
  if(h_pt_leadpt   [selbin]!=NULL)   h_pt_leadpt              [selbin]->Delete(); 
  if(h_pt_leadEta  [selbin]!=NULL)   h_pt_leadEta             [selbin]->Delete(); 
  if(h_pt_leadE    [selbin]!=NULL)   h_pt_leadE               [selbin]->Delete(); 
  if(h_pt_lagpt    [selbin]!=NULL)   h_pt_lagpt               [selbin]->Delete(); 
  if(h_pt_lagEta   [selbin]!=NULL)   h_pt_lagEta              [selbin]->Delete(); 
  if(h_pt_lagE     [selbin]!=NULL)   h_pt_lagE                [selbin]->Delete(); 
  if(h_pt_dilepEta [selbin]!=NULL)   h_pt_dilepEta            [selbin]->Delete(); 
  if(h_pt_Phidiff  [selbin]!=NULL)   h_pt_Phidiff             [selbin]->Delete(); 
  if(h_pt_dilepE   [selbin]!=NULL)   h_pt_dilepE              [selbin]->Delete(); 
  return kTRUE;
}

//----------------------------initLowptHistograms
Bool_t analyzer_histograms::initLowDiPtHistograms( TString uncbin ){
  ...
  for(unsigned int i=0; i<selbinnames.size(); ++i){
    ...
    TString hname_lowpt_leadpt                = "h_"+selbinnames[i]+"_lowpt_leadpt"  +uncbin ; 
    TString hname_lowpt_leadEta               = "h_"+selbinnames[i]+"_lowpt_leadEta"  +uncbin ; 
    TString hname_lowpt_leadE                 = "h_"+selbinnames[i]+"_lowpt_leadE"  +uncbin ; 
    TString hname_lowpt_lagpt                = "h_"+selbinnames[i]+"_lowpt_lagpt"  +uncbin ; 
    TString hname_lowpt_lagEta               = "h_"+selbinnames[i]+"_lowpt_lagEta"  +uncbin ; 
    TString hname_lowpt_lagE                 = "h_"+selbinnames[i]+"_lowpt_lagE"  +uncbin ; 
    TString hname_lowpt_dileppt               = "h_"+selbinnames[i]+"_lowpt_dileppt"  +uncbin ; 
    TString hname_lowpt_dilepEta               = "h_"+selbinnames[i]+"_lowpt_dilepEta"  +uncbin ; 
    TString hname_lowpt_Phidiff               = "h_"+selbinnames[i]+"_lowpt_dilepdiff"  +uncbin ; 
    TString hname_lowpt_dilepE               = "h_"+selbinnames[i]+"_lowpt_dilepE"  +uncbin ; 
    TString hname_lowpt_dilepMass               = "h_"+selbinnames[i]+"_lowpt_dilepMass"  +uncbin ; 
    
    h_lowpt_leadpt    [i] = initSingleHistogramTH1F( hname_lowpt_leadpt   , "AOD_lowpt_leadpt  " , 50, 0, 400); 
    h_lowpt_leadEta    [i] = initSingleHistogramTH1F( hname_lowpt_leadEta   , "AOD_lowpt_leadEta  " , 30, -5, 5); 
    h_lowpt_leadE    [i] = initSingleHistogramTH1F( hname_lowpt_leadE   , "AOD_lowpt_leadE  " , 50, 0, 400); 
    h_lowpt_lagpt    [i] = initSingleHistogramTH1F( hname_lowpt_lagpt   , "AOD_lowpt_lagpt  " , 50, 0, 400); 
    h_lowpt_lagEta    [i] = initSingleHistogramTH1F( hname_lowpt_lagEta   , "AOD_lowpt_lagEta  " , 30, -5, 5); 
    h_lowpt_lagE    [i] = initSingleHistogramTH1F( hname_lowpt_lagE   , "AOD_lowpt_lagE  " , 50, 0, 400); 
    h_lowpt_dileppt    [i] = initSingleHistogramTH1F( hname_lowpt_dileppt   , "AOD_lowpt_dileppt  " , 50, 0, 400); 
    h_lowpt_dilepEta    [i] = initSingleHistogramTH1F( hname_lowpt_dilepEta   , "AOD_lowpt_dilepEta  " , 30, -5, 5); 
    h_lowpt_Phidiff    [i] = initSingleHistogramTH1F( hname_lowpt_Phidiff   , "AOD_lowpt_Phidiff  " , 30, -5, 5); 
    h_lowpt_dilepE    [i] = initSingleHistogramTH1F( hname_lowpt_dilepE   , "AOD_lowpt_dilepE  " , 50, 0, 400); 
    h_lowpt_dilepMass    [i] = initSingleHistogramTH1F( hname_lowpt_dilepMass   , "AOD_lowpt_dilepMass  " , 50, 0, 400); 
  }
  
  return kTRUE;
}

//----------------------------fillLowDiPtHistograms
Bool_t analyzer_histograms::fillLowDiPtHistograms(Float_t weight, int selbin)
{
  hist_file_out[selbin]->cd();

if(dilep_pt<30){
 if (fourVec_l1.Pt()>fourVec_l2.Pt()){
 h_lowpt_leadpt              [selbin]->Fill( fourVec_l1.Pt() , weight);  
 h_lowpt_leadEta             [selbin]->Fill( fourVec_l1.Eta()  , weight);  
 h_lowpt_leadE               [selbin]->Fill( fourVec_l1.E()  , weight); 
 h_lowpt_lagpt               [selbin]->Fill( fourVec_l2.Pt()  , weight); 
 h_lowpt_lagEta              [selbin]->Fill( fourVec_l2.Eta()  , weight); 
 h_lowpt_lagE                [selbin]->Fill( fourVec_l2.E()  , weight);}
else{ 
 h_lowpt_leadpt              [selbin]->Fill( fourVec_l2.Pt() , weight);  
 h_lowpt_leadEta             [selbin]->Fill( fourVec_l2.Eta()  , weight);  
 h_lowpt_leadE               [selbin]->Fill( fourVec_l2.E()  , weight); 
 h_lowpt_lagpt               [selbin]->Fill( fourVec_l1.Pt()  , weight); 
 h_lowpt_lagEta              [selbin]->Fill( fourVec_l1.Eta()  , weight); 
 h_lowpt_lagE                [selbin]->Fill( fourVec_l1.E()  , weight);}

 h_lowpt_dileppt             [selbin]->Fill( dilep_pt  , weight); 
 h_lowpt_dilepEta            [selbin]->Fill( fourVec_ll.Eta()  , weight); 
 h_lowpt_Phidiff             [selbin]->Fill( fabs(fourVec_l1.Phi()-fourVec_l2.Phi()) , weight); 
 h_lowpt_dilepE              [selbin]->Fill( fourVec_ll.E()  , weight); 
 h_lowpt_dilepMass           [selbin]->Fill( dilep_mass  , weight); }
 return kTRUE;
}

//----------------------------writeLowDiPtHistograms
Bool_t analyzer_histograms::writeLowDiPtHistograms(int selbin)
{
  hist_file_out[selbin]->cd();
  h_lowpt_leadpt             [selbin]->Write(); 
  h_lowpt_leadEta            [selbin]->Write(); 
  h_lowpt_leadE              [selbin]->Write(); 
  h_lowpt_lagpt              [selbin]->Write(); 
  h_lowpt_lagEta             [selbin]->Write(); 
  h_lowpt_lagE               [selbin]->Write(); 
  h_lowpt_dileppt            [selbin]->Write(); 
  h_lowpt_dilepEta           [selbin]->Write(); 
  h_lowpt_Phidiff            [selbin]->Write(); 
  h_lowpt_dilepE             [selbin]->Write(); 
  h_lowpt_dilepMass          [selbin]->Write(); 
  return kTRUE;
}

//----------------------------deleteLowDiPtHistograms
Bool_t analyzer_histograms::deleteLowDiPtHistograms(int selbin)
{
  //printf("deleteMETHTHistograms\n");
  hist_file_out[selbin]->cd();
  if(h_lowpt_leadpt   [selbin]!=NULL)   h_lowpt_leadpt              [selbin]->Delete(); 
  if(h_lowpt_leadEta  [selbin]!=NULL)   h_lowpt_leadEta             [selbin]->Delete(); 
  if(h_lowpt_leadE    [selbin]!=NULL)   h_lowpt_leadE               [selbin]->Delete(); 
  if(h_lowpt_lagpt    [selbin]!=NULL)   h_lowpt_lagpt               [selbin]->Delete(); 
  if(h_lowpt_lagEta   [selbin]!=NULL)   h_lowpt_lagEta              [selbin]->Delete(); 
  if(h_lowpt_lagE     [selbin]!=NULL)   h_lowpt_lagE                [selbin]->Delete(); 
  if(h_lowpt_dileppt  [selbin]!=NULL)   h_lowpt_dileppt             [selbin]->Delete(); 
  if(h_lowpt_dilepEta [selbin]!=NULL)   h_lowpt_dilepEta            [selbin]->Delete(); 
  if(h_lowpt_Phidiff  [selbin]!=NULL)   h_lowpt_Phidiff             [selbin]->Delete(); 
  if(h_lowpt_dilepE   [selbin]!=NULL)   h_lowpt_dilepE              [selbin]->Delete(); 
  if(h_lowpt_dilepMass[selbin]!=NULL)   h_lowpt_dilepMass           [selbin]->Delete(); 
  return kTRUE;
}
//----------------------------initHighptHistograms
Bool_t analyzer_histograms::initHighDiPtHistograms( TString uncbin ){
  ...
  for(unsigned int i=0; i<selbinnames.size(); ++i){
    ...
    TString hname_highpt_leadpt                = "h_"+selbinnames[i]+"_highpt_leadpt"  +uncbin ; 
    TString hname_highpt_leadEta               = "h_"+selbinnames[i]+"_highpt_leadEta"  +uncbin ; 
    TString hname_highpt_leadE                 = "h_"+selbinnames[i]+"_highpt_leadE"  +uncbin ; 
    TString hname_highpt_lagpt                = "h_"+selbinnames[i]+"_highpt_lagpt"  +uncbin ; 
    TString hname_highpt_lagEta               = "h_"+selbinnames[i]+"_highpt_lagEta"  +uncbin ; 
    TString hname_highpt_lagE                 = "h_"+selbinnames[i]+"_highpt_lagE"  +uncbin ; 
    TString hname_highpt_dileppt               = "h_"+selbinnames[i]+"_highpt_dileppt"  +uncbin ; 
    TString hname_highpt_dilepEta               = "h_"+selbinnames[i]+"_highpt_dilepEta"  +uncbin ; 
    TString hname_highpt_Phidiff               = "h_"+selbinnames[i]+"_highpt_dilepdiff"  +uncbin ; 
    TString hname_highpt_dilepE               = "h_"+selbinnames[i]+"_highpt_dilepE"  +uncbin ; 
    TString hname_highpt_dilepMass               = "h_"+selbinnames[i]+"_highpt_dilepMass"  +uncbin ; 
    
    h_highpt_leadpt    [i] = initSingleHistogramTH1F( hname_highpt_leadpt   , "AOD_highpt_leadpt  " , 50, 0, 400); 
    h_highpt_leadEta    [i] = initSingleHistogramTH1F( hname_highpt_leadEta   , "AOD_highpt_leadEta  " , 30, -5, 5); 
    h_highpt_leadE    [i] = initSingleHistogramTH1F( hname_highpt_leadE   , "AOD_highpt_leadE  " , 50, 0, 400); 
    h_highpt_lagpt    [i] = initSingleHistogramTH1F( hname_highpt_lagpt   , "AOD_highpt_lagpt  " , 50, 0, 400); 
    h_highpt_lagEta    [i] = initSingleHistogramTH1F( hname_highpt_lagEta   , "AOD_highpt_lagEta  " , 30, -5, 5); 
    h_highpt_lagE    [i] = initSingleHistogramTH1F( hname_highpt_lagE   , "AOD_highpt_lagE  " , 50, 0, 400); 
    h_highpt_dileppt    [i] = initSingleHistogramTH1F( hname_highpt_dileppt   , "AOD_highpt_dileppt  " , 50, 0, 400); 
    h_highpt_dilepEta    [i] = initSingleHistogramTH1F( hname_highpt_dilepEta   , "AOD_highpt_dilepEta  " , 30, -5, 5); 
    h_highpt_Phidiff    [i] = initSingleHistogramTH1F( hname_highpt_Phidiff   , "AOD_highpt_Phidiff  " , 30, -5, 5); 
    h_highpt_dilepE    [i] = initSingleHistogramTH1F( hname_highpt_dilepE   , "AOD_highpt_dilepE  " , 50, 0, 400); 
    h_highpt_dilepMass    [i] = initSingleHistogramTH1F( hname_highpt_dilepMass   , "AOD_highpt_dilepMass  " , 50, 0, 400); 
  }
  
  return kTRUE;
}

//----------------------------fillHighDiPtHistograms
Bool_t analyzer_histograms::fillHighDiPtHistograms(Float_t weight, int selbin)
{

  hist_file_out[selbin]->cd();
if(dilep_pt>30){
 if (fourVec_l1.Pt()>fourVec_l2.Pt()){
 h_highpt_leadpt              [selbin]->Fill( fourVec_l1.Pt() , weight);  
 h_highpt_leadEta             [selbin]->Fill( fourVec_l1.Eta()  , weight);  
 h_highpt_leadE               [selbin]->Fill( fourVec_l1.E()  , weight); 
 h_highpt_lagpt               [selbin]->Fill( fourVec_l2.Pt()  , weight); 
 h_highpt_lagEta              [selbin]->Fill( fourVec_l2.Eta()  , weight); 
 h_highpt_lagE                [selbin]->Fill( fourVec_l2.E()  , weight);}
else{ 
 h_highpt_leadpt              [selbin]->Fill( fourVec_l2.Pt() , weight);  
 h_highpt_leadEta             [selbin]->Fill( fourVec_l2.Eta()  , weight);  
 h_highpt_leadE               [selbin]->Fill( fourVec_l2.E()  , weight); 
 h_highpt_lagpt               [selbin]->Fill( fourVec_l1.Pt()  , weight); 
 h_highpt_lagEta              [selbin]->Fill( fourVec_l1.Eta()  , weight); 
 h_highpt_lagE                [selbin]->Fill( fourVec_l1.E()  , weight);}

 h_highpt_dileppt             [selbin]->Fill( dilep_pt  , weight); 
 h_highpt_dilepEta            [selbin]->Fill( fourVec_ll.Eta()  , weight); 
 h_highpt_Phidiff             [selbin]->Fill( fabs(fourVec_l1.Phi()-fourVec_l2.Phi()) , weight); 
 h_highpt_dilepE              [selbin]->Fill( fourVec_ll.E()  , weight); 
 h_highpt_dilepMass           [selbin]->Fill( dilep_mass  , weight); }
 return kTRUE;
}
//----------------------------writeHighDiPtHistograms
Bool_t analyzer_histograms::writeHighDiPtHistograms(int selbin)
{
  hist_file_out[selbin]->cd();
  h_highpt_leadpt             [selbin]->Write(); 
  h_highpt_leadEta            [selbin]->Write(); 
  h_highpt_leadE              [selbin]->Write(); 
  h_highpt_lagpt              [selbin]->Write(); 
  h_highpt_lagEta             [selbin]->Write(); 
  h_highpt_lagE               [selbin]->Write(); 
  h_highpt_dileppt            [selbin]->Write(); 
  h_highpt_dilepEta           [selbin]->Write(); 
  h_highpt_Phidiff            [selbin]->Write(); 
  h_highpt_dilepE             [selbin]->Write(); 
  h_highpt_dilepMass          [selbin]->Write(); 
  return kTRUE;
}

//----------------------------deleteHighDiPtHistograms
Bool_t analyzer_histograms::deleteHighDiPtHistograms(int selbin)
{
  //printf("deleteMETHTHistograms\n");
  hist_file_out[selbin]->cd();
  if(h_highpt_leadpt   [selbin]!=NULL)   h_highpt_leadpt              [selbin]->Delete(); 
  if(h_highpt_leadEta  [selbin]!=NULL)   h_highpt_leadEta             [selbin]->Delete(); 
  if(h_highpt_leadE    [selbin]!=NULL)   h_highpt_leadE               [selbin]->Delete(); 
  if(h_highpt_lagpt    [selbin]!=NULL)   h_highpt_lagpt               [selbin]->Delete(); 
  if(h_highpt_lagEta   [selbin]!=NULL)   h_highpt_lagEta              [selbin]->Delete(); 
  if(h_highpt_lagE     [selbin]!=NULL)   h_highpt_lagE                [selbin]->Delete(); 
  if(h_highpt_dileppt  [selbin]!=NULL)   h_highpt_dileppt             [selbin]->Delete(); 
  if(h_highpt_dilepEta [selbin]!=NULL)   h_highpt_dilepEta            [selbin]->Delete(); 
  if(h_highpt_Phidiff  [selbin]!=NULL)   h_highpt_Phidiff             [selbin]->Delete(); 
  if(h_highpt_dilepE   [selbin]!=NULL)   h_highpt_dilepE              [selbin]->Delete(); 
  if(h_highpt_dilepMass[selbin]!=NULL)   h_highpt_dilepMass           [selbin]->Delete(); 
  return kTRUE;
}
...
Bool_t analyzer_histograms::initAODCaloJetBasicHistograms( TString uncbin )
{
  ...
  //deleteAODCaloJetBasicHistograms(i);
      ...
      TString hname_lownCaloJet                 = "h_"+selbinnames[i]+"_lownCaloJet" +uncbin;
      TString hname_highnCaloJet                 = "h_"+selbinnames[i]+"_highnCaloJet" +uncbin;
      ...
      h_lownCaloJet                 [i] = initSingleHistogramTH1F( hname_lownCaloJet  , "lownCaloJet",  10,0,10);
      h_highnCaloJet                 [i] = initSingleHistogramTH1F( hname_highnCaloJet  , "highnCaloJet",  10,0,10);
...
Bool_t analyzer_histograms::fillAODCaloJetBasicHistograms(Float_t weight, int selbin, int jetbin)
{
  ...
  if(dilep_pt<30)
	{  h_lownCaloJet                 [selbin]->Fill ( aodcalojet_list.size() , weight );}
  else
    {h_highnCaloJet                 [selbin]->Fill ( aodcalojet_list.size() , weight );}
...
Bool_t analyzer_histograms::writeAODCaloJetBasicHistograms(int selbin, int jetbin)
{
  ...
  if(jetmultnames.at(jetbin) == "AllJets"){
   ...
   h_lownCaloJet                 [selbin]->Write();
   h_highnCaloJet                 [selbin]->Write();
...
Bool_t analyzer_histograms::deleteAODCaloJetBasicHistograms(int selbin)
{
  ...
  if(h_lownCaloJet  [selbin]!=NULL)    h_lownCaloJet                 [selbin]->Delete();
  if(h_highnCaloJet  [selbin]!=NULL)    h_highnCaloJet                 [selbin]->Delete();
...
//----------------------------initDiCutflowHistograms
Bool_t analyzer_histograms::initDiCutflowHistograms( TString uncbin ){

 for(unsigned int i=0; i<selbinnames.size(); ++i){

  //deleteCutflowHistograms(i);
  TString hname_highCutflow    = "h_"+selbinnames[i]+"_highCutflow"   +uncbin; 
  TString hname_highOnecut     = "h_"+selbinnames[i]+"_highOnecut"    +uncbin; 
  TString hname_highRawCutflow = "h_"+selbinnames[i]+"_highRawCutflow"+uncbin; 
  TString hname_highRawOnecut  = "h_"+selbinnames[i]+"_highRawOnecut" +uncbin; 
  TString hname_lowCutflow    = "h_"+selbinnames[i]+"_lowCutflow"   +uncbin; 
  TString hname_lowOnecut     = "h_"+selbinnames[i]+"_lowOnecut"    +uncbin; 
  TString hname_lowRawCutflow = "h_"+selbinnames[i]+"_lowRawCutflow"+uncbin; 
  TString hname_lowRawOnecut  = "h_"+selbinnames[i]+"_lowRawOnecut" +uncbin; 

  h_highCutflow    [i] = initSingleHistogramTH1F( hname_highCutflow , "Cutflow", 10,0,10);
  h_highOnecut     [i] = initSingleHistogramTH1F( hname_highOnecut  , "Onecut ", 10,0,10);
  h_highRawCutflow [i] = initSingleHistogramTH1F( hname_highRawCutflow , "RawCutflow", 10,0,10);
  h_highRawOnecut  [i] = initSingleHistogramTH1F( hname_highRawOnecut  , "RawOnecut ", 10,0,10);
  h_lowCutflow    [i] = initSingleHistogramTH1F( hname_lowCutflow , "Cutflow", 10,0,10);
  h_lowOnecut     [i] = initSingleHistogramTH1F( hname_lowOnecut  , "Onecut ", 10,0,10);
  h_lowRawCutflow [i] = initSingleHistogramTH1F( hname_lowRawCutflow , "RawCutflow", 10,0,10);
  h_lowRawOnecut  [i] = initSingleHistogramTH1F( hname_lowRawOnecut  , "RawOnecut ", 10,0,10);
 }
 return kTRUE;
}

//----------------------------fillDiCutflowHistograms
Bool_t analyzer_histograms::fillDiCutflowHistograms(Float_t weight, int selbin, Int_t localselint)
{
 if (dilep_pt>30){
 h_highCutflow[selbin] ->Fill( 1, weight );
 h_highOnecut[selbin]  ->Fill( 1, weight );
 h_highRawCutflow[selbin] ->Fill( 1 );
 h_highRawOnecut[selbin]  ->Fill( 1 );
 ...
 for( unsigned int i=1; i<8; ++i){
  ...
  if( notdead ){
   h_highCutflow[selbin]    ->Fill( 1+i, weight );
   h_highRawCutflow[selbin] ->Fill( 1+i );
  }
  if( localselint>>(i) & 1 ){
   h_highOnecut[selbin]    ->Fill( 1+i, weight );
   h_highRawOnecut[selbin] ->Fill( 1+i );
  }}

  }
 else{
 h_lowCutflow[selbin] ->Fill( 1, weight );
 h_lowOnecut[selbin]  ->Fill( 1, weight );
 h_lowRawCutflow[selbin] ->Fill( 1 );
 h_lowRawOnecut[selbin]  ->Fill( 1 );
 ...
 for( unsigned int i=1; i<8; ++i){
  ...
  if( notdead ){
   h_lowCutflow[selbin]    ->Fill( 1+i, weight );
   h_lowRawCutflow[selbin] ->Fill( 1+i );
  }
  if( localselint>>(i) & 1 ){
   h_lowOnecut[selbin]    ->Fill( 1+i, weight );
   h_lowRawOnecut[selbin] ->Fill( 1+i );
  }}
...
//----------------------------writeDiCutflowHistograms
Bool_t analyzer_histograms::writeDiCutflowHistograms(int selbin)
{
 h_highCutflow    [selbin]->Write();
 h_highOnecut     [selbin]->Write();
 h_highRawCutflow [selbin]->Write();
 h_highRawOnecut  [selbin]->Write();
 h_lowCutflow    [selbin]->Write();
 h_lowOnecut     [selbin]->Write();
 h_lowRawCutflow [selbin]->Write();
 h_lowRawOnecut  [selbin]->Write();
 return kTRUE;
}

//----------------------------deleteDiCutflowHistograms
Bool_t analyzer_histograms::deleteDiCutflowHistograms(int selbin)
{
  //printf("deleteCutflowHistograms\n");
  if(h_highCutflow   [selbin]!=NULL)  h_highCutflow    [selbin]->Delete();
  if(h_highOnecut    [selbin]!=NULL)  h_highOnecut     [selbin]->Delete();
  if(h_highRawCutflow[selbin]!=NULL)  h_highRawCutflow [selbin]->Delete();
  if(h_highRawOnecut [selbin]!=NULL)  h_highRawOnecut  [selbin]->Delete();
  if(h_lowCutflow   [selbin]!=NULL)  h_lowCutflow    [selbin]->Delete();
  if(h_lowOnecut    [selbin]!=NULL)  h_lowOnecut     [selbin]->Delete();
  if(h_lowRawCutflow[selbin]!=NULL)  h_lowRawCutflow [selbin]->Delete();
  if(h_lowRawOnecut [selbin]!=NULL)  h_lowRawOnecut  [selbin]->Delete();
  return kTRUE;
}
