...
Float_t analyzer_scalefactors::makeEventWeight(Float_t crossSec,
                                        Float_t lumi,
                                        Float_t nrevents, Float_t GenMean)
//Float_t analyzer_scalefactors::makeEventWeight(Float_t crossSec,
//                                        Float_t lumi,
//                                        Float_t nrEvents)
{
  ...
  Float_t GenWeight = AODGenEventWeight;
  //std::cout<<"This is GenWeight:"<<GenWeight<<std::endl;
  //if(isMC){ event_weight=lumi*crossSecScl/nrevents; }
  if(isMC){ event_weight=lumi*crossSecScl*GenWeight/(nrevents*GenMean); }
