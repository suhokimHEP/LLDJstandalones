...
;
std::cout << "Karem this is working up until this point-- BERRY" <<std::endl;
std::cout << drawSignal <<std::endl;
     // set max and draw
     Double_t ymax;
     ymax = std::max(h_bkgtotal->GetMinimum(), h_bkgtotal->GetMaximum() );
...
std::cout << "Karem this is working up until this point-- banana" <<std::endl;
     ...
     char lumistring [50];
     int dummy; 
std::cout << "Karem this is working up until this point-- APPLE" <<std::endl;
