...
void plot_bkgest(){
  ...
  TString filename_bkgest = "fout_ZH.root";

  TFile* file_bkg = TFile::Open(filename_bkg, "READ");
  TFile* file_bkgest = TFile::Open(filename_bkgest, "READ");

  TH1F* h_Totbkg = (TH1F*)file_bkg->Get("h_Totbkg_mu_ZH_AOD_nSelectedAODCaloJetTag");
  TH1F* h_Totbkg_bkgest = (TH1F*)file_bkgest->Get("h_Totbkg_bkgest");
